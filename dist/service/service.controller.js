...
let ServiceController = class ServiceController {
    ...
    async newService(serviceDto) {
        return this.serviceService.createService(serviceDto);
    }
    async addServiceToUser(req, serviceId) {
...
], ServiceController.prototype, "findService", null);
__decorate([
    (0, roles_decorator_1.Roles)(roles_enum_1.ROLES.Applicant, roles_enum_1.ROLES.Ward),
    (0, common_1.Get)('all'),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ServiceController.prototype, "newService", null);
__decorate([
    (0, roles_decorator_1.Roles)(roles_enum_1.ROLES.Applicant, roles_enum_1.ROLES.Ward),
    ...
    __metadata("design:returntype", Promise)
], ServiceController.prototype, "addServiceToUser", null);
